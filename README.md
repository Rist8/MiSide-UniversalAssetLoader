...
1. **Download** `UniversalAssetLoaderRelease-0.9.1.zip` from the [releases page](https://github.com/Rist8/MiSide-UniversalAssetLoader/releases/tag/Release-0.9.1).  
   > **Скачайте** `UniversalAssetLoaderRelease-0.9.1.zip` с [страницы релизов](https://github.com/Rist8/MiSide-UniversalAssetLoader/releases/tag/Release-0.9.1).
