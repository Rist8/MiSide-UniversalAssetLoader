...
1. **Download** `UniversalAssetLoaderRelease-0.11.3.zip` from the [releases page](https://github.com/Rist8/MiSide-UniversalAssetLoader/releases/latest).  
   > **Скачайте** `UniversalAssetLoaderRelease-0.11.3.zip` с [страницы релизов](https://github.com/Rist8/MiSide-UniversalAssetLoader/releases/latest).
