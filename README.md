...
1. **Download** `UniversalAssetLoaderRelease-0.9.2.zip` from the [releases page](https://github.com/Rist8/MiSide-UniversalAssetLoader/releases/tag/Release-0.9.2).  
   > **Скачайте** `UniversalAssetLoaderRelease-0.9.2.zip` с [страницы релизов](https://github.com/Rist8/MiSide-UniversalAssetLoader/releases/tag/Release-0.9.2).
