...
public class Commands
{
    ...
    Dictionary<string, SkinnedMeshRenderer> renderers, Dictionary<string, MeshRenderer> staticRenderers, string blendShapeKey = null)
    {
        ...
        if (renderers.ContainsKey(mita.name + command.args[1]))
        {
            ...
            skinnedRenderer.sharedMesh = AssetLoader.BuildMesh(meshData, new AssetLoader.ArmatureData(skinnedRenderer), ((command.args[1] == "Head") || HeadSkinnedAppendix.Contains(command.args[1])), blendShapeKey);
        ...
        else if (staticRenderers.ContainsKey(mita.name + command.args[1]))
        {
            ...
            staticRenderer.GetComponent<MeshFilter>().mesh = AssetLoader.BuildMesh(meshData, null, ((command.args[1] == "Head") || HeadSkinnedAppendix.Contains(command.args[1])), blendShapeKey);
