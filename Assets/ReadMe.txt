...
[1] greenscreen - turns on greenscreen with default position and rotation parameteres
    ...
    greenscreen rot 10 20 30 turns on greenscreen with default position and default rotation parameteres + vector(10,20,30)
    greenscreen pos 0,1 0,2 0,3 rot 10 20 30 turns on greenscreen with default position + vector(0.1,0.2,0.3) and default rotation parameteres + vector(10,20,30)
    while in greenscreen camera mode you can move with WASD, Ctrl(down), Space(Up), hold Shift(Speed up) and rotate it with mouse